...
<@nav.nav>
    <form method="post">
        ...
        <div class="form-group">
            <label for="description">Повестка</label>
        ...
        <div class="form-group">
            ...
            <input type="text" name="applicant" id="applicant" class="form-control ${(applicantError??)?string('is-invalid', '')}"
        ...
        <div class="form-group">
            ...
            <input type="text" name="approxDateOfMeeting" class="form-control" value="<#if committee??>${committee.approxDateOfMeeting}</#if>"/>
        </div>

        <div class="form-group">
            <label for="applicant">Рецензент</label>
            <input type="text" name="reviewer" id="reviewer" class="form-control ${(reviewerError??)?string('is-invalid', '')}"
        ...
        <div class="form-group">
            ...
            <textarea class="form-control ${(initialDecisionError??)?string('is-invalid', '')}" name="initialDecision" id="initialDecision"
                      rows="3"></textarea>
